#!/bin/bash -l
#SBATCH --job-name=yolo_controlnet_withCB_oversampled_fade_it3  # ADAPT
...
# /home/woody/iwi5/iwi5215h/masterarbeit/repos/odor-images/yolov11/controlnet_withCB_oversampled_fading/controlnet_withCB_oversampled_fading.yaml
# best performing model /home/woody/iwi5/iwi5215h/masterarbeit/repos/ultralytics/runs/detect/train26/weights/best.pt

# python ./my_yolo_train.py --yaml /home/woody/iwi5/iwi5215h/masterarbeit/repos/odor-images/yolov11/baseline_CN_wCB_oversampled_fading/baseline_CN_wCB_oversampled_fading.yaml
python ./my_yolo_train.py --model "yolo11m.pt" --yaml /home/woody/iwi5/iwi5215h/masterarbeit/repos/odor-images/yolov11/controlnet_withCB_oversampled_fading/controlnet_withCB_oversampled_fading.yaml
