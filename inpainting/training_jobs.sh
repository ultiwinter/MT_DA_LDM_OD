#!/bin/bash -l
#SBATCH --job-name=baseline_further_map_training  # ADAPT
...
# my repo
python ./mysrc/od_training.py -m train --nepochs 100 --logckptdir output --checkptfile 861970/best-checkpoint-epoch=94-val_loss=0.28.ckpt
