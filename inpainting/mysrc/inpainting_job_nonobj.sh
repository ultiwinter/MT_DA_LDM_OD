#!/bin/bash -l
#SBATCH --job-name=nonobj_inpainting_2112_b1  # ADAPT
...
# my repo
python mysrc/automatic_noncond_inpainting.py --num_samples 1 --mask_dir /home/woody/iwi5/iwi5215h/masterarbeit/repos/odor-images/nonobject_random_mask_masks --output_dir /home/woody/iwi5/iwi5215h/masterarbeit/repos/odor-images/synthesized_nonobj_negprompt_DA_images
