#!/bin/bash -l
#SBATCH --job-name=gradient_inpainting_2112_b1  # ADAPT
...
# my repo
python mysrc/automatic_inpaining.py --num_samples 1 --mask_dir /home/woody/iwi5/iwi5215h/masterarbeit/repos/odor-images/gradient_based_masks/ --output_dir /home/woody/iwi5/iwi5215h/masterarbeit/repos/odor-images/synthesized_gradient_DA_images
