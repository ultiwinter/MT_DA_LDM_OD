...
def parse_args():
    ...
    parser.add_argument('--train_dir', default='/home/woody/iwi5/iwi5215h/masterarbeit/repos/odor-images/TEST8_combined_random_partial/', help='Path to training images directory.')  # FINAL_FINAL_overlayed_imgs_controlnet_hed_blankImgs_filled_0901
    parser.add_argument('--train_json', default='/home/woody/iwi5/iwi5215h/masterarbeit/repos/odor-images/TEST8_combined_random_partial_annotations.json', help='Path to COCO training annotations JSON file.')  # FINAL_FINAL_my_modified_train_plus_withClassBalance_added_hed_filled_adjusted
    parser.add_argument('--dataset_name', default='TEST8_FINAL_randomP_CB', help='Dataset name for YOLO output.')  # FINAL_controlnet_withCB_blank_filled
