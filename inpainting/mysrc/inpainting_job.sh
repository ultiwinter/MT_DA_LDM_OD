#!/bin/bash -l
#SBATCH --job-name=random_partial_inpainting_0901_1  # ADAPT
...
python mysrc/automatic_inpaining.py --num_samples 1 --mask_dir /home/woody/iwi5/iwi5215h/masterarbeit/repos/odor-images/random_partial_masks --output_dir /home/woody/iwi5/iwi5215h/masterarbeit/repos/odor-images/synthesized_random_partial_RWML_DA_CB
