#!/bin/bash -l
#SBATCH --job-name=ent_inpainting_0901_1  # ADAPT
...
python mysrc/automatic_inpaining.py --num_samples 1 --mask_dir /home/woody/iwi5/iwi5215h/masterarbeit/repos/odor-images/reversed_entropy_based_masks --output_dir /home/woody/iwi5/iwi5215h/masterarbeit/repos/odor-images/synthesized_reversed_entropy_RWML_DA_CB
