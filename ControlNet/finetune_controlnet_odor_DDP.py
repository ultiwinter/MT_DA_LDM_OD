...
resume_path = './models/control_sd15_hed.pth' # models/control_sd15_hed.pth
batch_size = 16
logger_freq = 300
learning_rate = 1e-5
sd_locked = True
...
checkpoint_callback = ModelCheckpoint(
    dirpath="./checkpoints",   
    filename=f"finetuned-instr-oilpaint-hed-controlnet-b{batch_size}-s256-{timestamp}-{{epoch:02d}}",
    save_top_k=1,                                     
)
